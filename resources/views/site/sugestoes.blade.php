    ...
    <section class="mx-1">
        <div class="container col-12 col-md-8 col-lg-6 bg-dark-blue py-4 px-3 rounded-3 mb-5">
            <div class="d-flex justify-content-between mb-3">
                ...
                <button class="btn btn-padrao btn-cel col-2" disabled>Sugestão</button>
            ...
            <div class="container">
                ...
                <div class="form-color p-3 rounded-3 mx-auto">
                    <form action="">
                        ...
                        <h5 class="mb-4"><i class="bi bi-file-earmark-text-fill"></i> Descrição da Sugestão</h5>
                        <div class="row mb-3">
